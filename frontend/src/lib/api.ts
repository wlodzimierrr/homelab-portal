...
export type BundleTopology = 'single-service' | 'frontend-backend' | 'frontend-backend-db'
export type FrontendTemplateId = 'react' | 'nextjs' | 'vue' | 'static-nginx'
export type BackendTemplateId = 'python-fastapi' | 'python-django' | 'python-flask' | 'node-express' | 'node-nestjs'
