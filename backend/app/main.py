...
from app.services.builders import (
    _build_deployment_service,
    _build_observability_service,
    _build_catalog_service,
    _build_scaffold_admin_service,
)
import app.services.builders as _builders_module
...
_builders_module._deployment_history_cache = deployment_history_cache
_builders_module._deployment_reconcile_cache = deployment_reconcile_cache
_builders_module._metrics_summary_cache = metrics_summary_cache
_builders_module._timeline_cache = timeline_cache
_builders_module._logs_quickview_cache = logs_quickview_cache
_builders_module._logger = logger
...
# --- late-bind deployment helpers into builders module -----------------------
# builders.py declares these as None sentinels. We assign after the function
# definitions above so the module receives the final callable objects.
_builders_module._maybe_reconcile_recent_deployments = _maybe_reconcile_recent_deployments
_builders_module._upsert_deployment_record_row = _upsert_deployment_record_row
