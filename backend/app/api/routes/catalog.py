...
def register_routes(app: FastAPI, main_module: ModuleType) -> None:
    app.add_api_route(
        "/projects",
        endpoint=wrap_sync_endpoint(main_module.list_projects),
        methods=["GET"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.get_project_catalog_diagnostics),
        methods=["GET"],
    ...
    app.add_api_route(
        "/projects",
        endpoint=wrap_sync_endpoint(main_module.create_project),
        methods=["POST"],
    ...
    app.add_api_route(
        "/services",
        endpoint=wrap_sync_endpoint(main_module.list_services),
        methods=["GET"],
    ...
    app.add_api_route(
        "/services/{service_id}",
        endpoint=wrap_sync_endpoint(main_module.get_service),
        methods=["GET"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.get_catalog_reconciliation),
        methods=["GET"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.sync_service_registry),
        methods=["POST"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.get_service_registry_diagnostics),
        methods=["GET"],
