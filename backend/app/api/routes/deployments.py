...
def register_routes(app: FastAPI, main_module: ModuleType) -> None:
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.reconcile_deployments),
        methods=["POST"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.get_deployment),
        methods=["GET"],
    ...
    app.add_api_route(
        "/deployments",
        endpoint=wrap_sync_endpoint(main_module.create_deployment_record),
        methods=["POST"],
        response_model=main_module.DeploymentRecordResponse,
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.cancel_deployment),
        methods=["POST"],
        response_model=main_module.DeploymentRecordResponse,
        tags=["metadata"],
    )
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.request_portal_deploy_to_dev),
        methods=["POST"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.request_portal_promote_to_prod),
        methods=["POST"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.list_service_rollback_candidates),
        methods=["GET"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.request_service_rollback),
        methods=["POST"],
    ...
    app.add_api_route(
        "/rollbacks",
        endpoint=wrap_sync_endpoint(main_module.request_portal_rollback),
        methods=["POST"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.get_service_deployments),
        methods=["GET"],
    ...
    app.add_api_route(
        ...
        endpoint=wrap_sync_endpoint(main_module.get_service_deployment_info),
        methods=["GET"],
